...
public class Invoice {
    ...
    public Invoice(int slNo, int customerOrderID, int salesOrg, String distributionChannel,
                   String division, float releasedCreditValue, String purchaseOrderType, int companyCode,
                   String orderCreationDate, String orderCreationTime, String creditControlArea,
                   int soldToParty, float orderAmount, String requestedDeliveryDate, String orderCurrency,
                   String creditStatus, int customerNumber, float amountInUsd, long uniqueCustNumber) {
        this.slNo = slNo;
